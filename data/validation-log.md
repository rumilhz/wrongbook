...
- [2026-09-02] RULE 文档 回填=README 首份验证报告（周期 08-06 ~ 09-02，提前于 09-06）：避错 3 / 复发 2 / 复发率 40%；诚实声明命中率因检索次数 T 未记录不统计、08-14~09-02 区间沉淀未逐日归因按批量计；同日升级沉淀可见仪式 + add-lesson.py
